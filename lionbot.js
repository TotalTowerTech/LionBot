...
client.login('MzU3MzAzNDE0MzIyODg4NzE1.DVH5FA.F27e8fBnV8gAAQtu5QaxWdzn2O8')
...
fs.readdir(`./modules/commands/${f}`, (err, files) => {
    ...
    modules.forEach((f, i) => {
        let props = require(`/Users/nayab_warach/Documents/Discord/LionBot/LionBot/LionBot/modules/commands/${f}`);
        try {
